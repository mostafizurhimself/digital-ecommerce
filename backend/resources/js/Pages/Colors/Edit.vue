<template>
    <form-view @submitted="save">
        <template #title>Edit Color</template>
        <template #form>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <jet-checkbox v-model:checked="form.isGradient" />
            ...
            <div class="mb-4" v-if="form.isGradient">
                ...
                <jet-image-input :url="color.primaryMediaUrl" @change="handleImageChange" class="w-64"></jet-image-input>
