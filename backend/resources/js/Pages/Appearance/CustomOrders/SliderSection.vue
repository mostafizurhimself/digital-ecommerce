<template>
    <div>
        <jet-card-section @submitted="save">
            ...
            <template #description>Change your Custom Order slider content.</template>
            <template #action>
    ...
    export default {
     ...
     methods: {
        ...
        save() {
            if (this.edit) {
                this.form.post(
                    route("appearance.custom-orders.slider.edit", this.form.id),
                    {
                        onSuccess: () => {
                            this.edit = false;
                            this.closeModal();
        ...
        closeModal() {
         ...
         deleteSlide(index) {
            this.form.delete(
                route(
                    "appearance.custom-orders.slider.delete",
