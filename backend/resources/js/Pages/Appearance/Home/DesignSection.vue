<template>
    <jet-form-section @submitted="save">
        <template #title>Design Section</template>
        <template #description>Change home page design section settings.</template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-image-input :url="$page.props.design?.primaryMediaUrl" @change="handleBannerChange"></jet-image-input>
    ...
    data() {
        return {
            form: this.$inertia.form({
                title: this.$page.props.design?.data?.title,
                subtitle: this.$page.props.design?.data?.subtitle,
                description: this.$page.props.design?.data?.description,
                banner: null,
            }),
        };
    },
