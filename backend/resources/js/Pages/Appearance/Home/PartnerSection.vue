<template>
    <jet-form-section @submitted="save">
        <template #title>Partner Section</template>
        <template #description>Change home page partner section content.</template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                 <jet-label for="show">
                    <div class="flex items-center">
                        <jet-checkbox name="show" id="show" v-model:checked="form.show" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-image-input :url="$page.props.partner?.primaryMediaUrl" @change="handleBannerChange"></jet-image-input>
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                subtitle: this.$page.props.partner?.data?.subtitle,
                description: this.$page.props.partner?.data?.description,
                show: true,
                banner: null,
            }),
        };
