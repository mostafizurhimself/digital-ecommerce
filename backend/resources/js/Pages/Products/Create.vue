				...
				<tabs :options="{ useUrlFragment: false }" nav-item-class="tab-item">
					...
					<tab name="General Info">
						...
						<div class="mb-4">
							...
							<jet-input id="note" type="text" class="mt-1 block w-full" v-model="form.note" ref="note" autocomplete="note" />
					...
					<tab name="Others" class="mt-5">
						...
						<div class="mb-4">
							...
							<jet-multiple-image-input @change="handleImagesChange"></jet-multiple-image-input>
						...
						<div class="mb-4">
							...
							<jet-image-input @change="handleThumbnailChange"></jet-image-input>
						...
						<div class="mb-4">
							...
							<jet-file-input @change="handleFileChange"></jet-file-input>
