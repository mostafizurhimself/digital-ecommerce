		...
		<div class="container">
			...
			<div class="row mt-2 mt-sm-4 mt-md-5 mt-lg-6 mb-2 mb-sm-3 mb-md-4 mb-lg-5">
				...
				<div class="col-12 col-lg-6 offset-lg-3 px-4 px-sm-7  text-center pt-3">
					<p>
						We are so grateful for the pleasure of serving you and hope we will meet your expectations. We'll start working on the color change, and it may take us up to one week. You will receive a notification by email as soon as your color change is ready.
					</p>
				</div>
			</div>
			...
			<div class="row my-6 mx-md-10">
				<div class="col-12 col-lg-6 offset-lg-3 text-center">
					<p>
						...
						<nuxt-link to="/profile/color-changes" title="my Designs" style="color: #30d5c8" >color changes</nuxt-link>.
					</p>
				</div>
				<div></div>
			</div>
