                  ...
                  | currency(
                    ...
                    $store.state.currency.exchangeRate
						...
						<div class="d-flex align-items-center mt-3">
							<nuxt-link class="btn btn-primary px-4" :to="`/preview-designs/${product.id}/cart`">
								Submit A Request
							</nuxt-link>
						</div>
							...
							<div class="col-sm-12">
								<div>
									...
									<div class="row">
										...
										<div class="col-12 pb-2">
											<span class="font-bold">Change the car! See the difference!</span>
											<!-- <span> {{ product.description }} </span> -->
											<br />
											<span>
												Get to see a preview of your favorite car wrap design on
												a specific car. You will be able to compare and see if
												the design goes along with your vehicle!
											</span>
										</div>
										<div class="col-12 pb-2">
